...
async def _(event):
    ...
    sandy = await event.edit(
        event,
        "**❃ جـار اعـادة تـشـغـيـل  الـسـورس\nارسل** `.فحص` **او** `.الاوامر` **للتحقق مما إذ كان البوت شغال ، يَتَاެخِࢪ فَدَ 1 - 2 دَقِيَقِة ݪاެعَاެدَة اެݪتَشِغِيَݪ اެنِطَيَ مِجَاެݪ حِبَ*",
    )
    try:
