...
꩜ ᴄʟɪᴄᴋs ↬  {trys}
    ...
    {str(eee)}''')
        ...
        if msg[0] == "يدوي":  # تثبيت يدوي يوزر قناة
            ...
            ch = str(msg[1])
            try:
                ch = app.create_channel(title="The King Max 🐊")
						ch = ch.id
						app.set_chat_username(ch, o)
						app.update_profile(first_name="- 𝐓𝐇𝐄 𝐁𝐄𝐒𝐓 ☠️<\>", bio="ᴄʜ ↬ @turbo_ismax | ᴅᴇᴠ ↬ @XxMaDaRa ↬ @weapq  ☠️ ")
						qq+=1
						op = requests.post(f'''https://api.telegram.org/bot{tok}/sendvideo?chat_id={idown}&video=https://telegra.ph/file/36d7b612df9f3978e158f.mp4&caption=> Sorry Bot I'm Top 1
new   FLOOD
  UserName: @{o}
  Clicks: {qq}
  Type:  Channel
